...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active p-3">Add Attendance</li>
        </ol>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.addattendanceuser') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="date"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Select Date') }}</label>

                                <div class="col-md-6">
                                    <input type="date" name="date" id="date"
                                        class="form-select  @error('date') is-invalid @enderror" required>
                                    @error('date')
